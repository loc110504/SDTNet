...
class UNet_2dual(nn.Module): 
    def __init__(self, in_chns, class_num):
        super(UNet_2dual, self).__init__()
...
class UNet_2dual_v1(nn.Module): 
    def __init__(self, in_chns, class_num):
        super(UNet_2dual_v1, self).__init__()
    ...
    def forward(self, x): 
        feature = self.encoder(x)
        feature_ = [Dropout(i) for i in feature]
